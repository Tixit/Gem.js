...
function doyourthang(watch) {
    build("blocks.browser", watch, {name: 'blocks', output: {path:__dirname+'/../../dist/', name: "blocks.umd.js"}})
    build("test/blocks.tests", watch, {name: 'blocksTests', minify: false, output: {path:__dirname+'/../test/generated/'}})
    build("test/performance.tests", watch, {name: 'performanceTests', minify: false, output: {path:__dirname+'/../test/generated/'}})
}
